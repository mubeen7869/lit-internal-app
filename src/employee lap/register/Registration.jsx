...
<div className="form-section">
        ...
        {accordionState.experienceHistory && (
          ...
          {/* Add more rows as needed */}
          <tr>
            <td><input type="text" name="company1" id="company1" /></td>
            <td><input type="text" name="designation1" id="designation1" /></td>
            <td><input type="text" name="joiningDate1" id="joiningDate1" /></td>
            <td><input type="text" name="resigningDate1" id="resigningDate1" /></td>
            <td><input type="text" name="experienceYears1" id="experienceYears1" /></td>
            <td><input type="text" name="remarks1" id="remarks1" /></td>
          </tr>
          <tr>
            <td><input type="text" name="company2" id="company2" /></td>
            <td><input type="text" name="designation2" id="designation2" /></td>
            <td><input type="text" name="joiningDate2" id="joiningDate2" /></td>
            <td><input type="text" name="resigningDate2" id="resigningDate2" /></td>
            <td><input type="text" name="experienceYears2" id="experienceYears2" /></td>
...
{/* Section 11: Employee Nomination Details */}
<div className="form-section">
        <h6 onClick={() => toggleAccordion("employeeNomination")}>
          {accordionState.employeeNomination ? "11. Employee Nomination -" : "11. Employee Nomination +"}
        </h6>
        {accordionState.employeeNomination && (
          ...
          <tr>
            ...
            <td><input type="text" name="nomineeRelation" id="nomineeRelation" /></td>
          </tr>
          <tr>
            <td>Age of the Nominee:</td>
            <td><input type="text" name="nomineeAge" id="nomineeAge" /></td>
          </tr>
          <tr>
            <td>Address of the Nominee:</td>
            <td><input type="text" name="nomineeAddress" id="nomineeAddress" /></td>
          </tr>
          <tr>
            <td>Phone number of the Nominee:</td>
            <td><input type="text" name="nomineePhoneNumber" id="nomineePhoneNumber" /></td>
          </tr>
        </tbody>
          </table>
        )}
